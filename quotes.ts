...
export const UZBEK_MOTIVATIONAL_QUOTES: string[] = [
  ...
  "⚡️ 💎 Bugungi mehnatingiz — ertangi g'alabangiz poydevoridir.",
  ...
  "🔥 ⚡️ Odatlaringizni o'zgartiring, hayotingiz o'zgaradi!",
  ...
  "⏰ ⚡️ Har bir daqiqa o'z maqsadlaringizga yaqinlashish uchun imkoniyatdir.",
